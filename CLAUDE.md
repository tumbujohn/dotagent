...
**Description:** When writing content for the application or website, always use this writing style. It is intended to produce human quality writings and content for the given project.
...
• AVOID markdown.
• AVOID asterisks.
• AVOID these words and should only use them when absolutely necessary:
